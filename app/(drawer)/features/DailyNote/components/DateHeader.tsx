...
import { getNextMonthColor } from '@/app/(drawer)/features/DailyNote/helpers/useDateHeader';
import { getFillColorForMonth } from '@/src/styles/monthsColor';
import { DateHeaderProps } from '@/app/(drawer)/features/DailyNote/types/DateHeader';
